...
- **T002 — Lập ma trận benchmark có nguồn.** **Kết quả:** từng năng lực tham chiếu được phân loại `đã quan sát / store claim / chưa xác minh / ngoài phạm vi`. **DoD/Bằng chứng:** ma trận truy ngược từ feature đến nguồn, task và tiêu chí nghiệm thu; không có claim “giống hệt” thiếu bằng chứng. **Phụ thuộc:** T001. **Tuyến:** Core + Browser. **Trạng thái:** `IN_PROGRESS`.
