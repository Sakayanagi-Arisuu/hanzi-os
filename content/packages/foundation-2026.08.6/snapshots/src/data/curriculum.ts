import runtimeCatalogJson from "../../content/packages/foundation-2026.08.6/runtime-catalog.json";
...
export const CONTENT_VERSION = "foundation-2026.08.6";
...
const LEARNER_LESSON_TITLES_VI: Readonly<Record<string, string>> = {
  "boot-4": "Cặp thanh điệu",
};

export const LESSONS: Lesson[] = RUNTIME_CATALOG.lessons.map((item) => ({
  ...item,
  title: LEARNER_LESSON_TITLES_VI[item.id] ?? item.title,
}));
...
const COURSE_UNIT_METADATA: Array<Omit<CourseUnit, "lessons">> = [
  ...
  {
    id: "hsk3-paragraph-input",
    code: "HSK3-01",
    stage: "Đọc-nghe đoạn có ngữ cảnh",
    title: "Ý chính, chi tiết và ghi chú",
    chineseTitle: "段落输入",
    description: "Hai mươi lăm bài đọc-nghe đoạn tám dòng, nhận diện ý chính, chi tiết và tóm lược có bằng chứng.",
    color: "jade",
  },
  {
    id: "hsk3-narration",
    code: "HSK3-02",
    stage: "Ngữ pháp trong tường thuật",
    title: "Kể lại sự kiện có liên kết",
    chineseTitle: "叙事表达",
    description: "Mười lăm bài vận dụng 96 điểm ngữ pháp và 22 nhiệm vụ để kể lại theo trình tự rõ ràng.",
    color: "gold",
  },
  {
    id: "hsk3-guided-production",
    code: "HSK3-03",
    stage: "Sản xuất có hướng dẫn",
    title: "Viết và trình bày đoạn HSK3",
    chineseTitle: "引导输出",
    description: "Mười lăm bài ghi chú, tái dựng, kể lại, viết đoạn và giải thích có self-reveal để tự sửa.",
    color: "cyan",
  },
  {
    id: "hsk4-deep-comprehension",
    code: "HSK4-01",
    stage: "Đọc-nghe chuyên sâu",
    title: "Văn bản dài, bằng chứng và suy luận",
    chineseTitle: "深度理解",
    description: "Ba mươi sáu bài đọc-nghe nhiều đoạn để lập sơ đồ khái niệm, tiến trình, nguyên nhân, so sánh và quan điểm.",
    color: "jade",
  },
  {
    id: "hsk4-summary-argument",
    code: "HSK4-02",
    stage: "Tóm tắt và lập luận",
    title: "Paraphrase, tóm tắt và phản biện",
    chineseTitle: "概括与论证",
    description: "Hai mươi bốn bài vận dụng 95 điểm ngữ pháp và 30 nhiệm vụ để diễn đạt chính xác, có dẫn chứng và giới hạn.",
    color: "gold",
  },
  {
    id: "hsk4-timed-integration",
    code: "HSK4-03",
    stage: "Tích hợp có giới hạn thời gian",
    title: "Đọc-nghe-viết-nói tích hợp",
    chineseTitle: "综合限时训练",
    description: "Mười tám bài với 106 prompt luyện tổng hợp nhiều nguồn, lập luận viết, bảo vệ bằng lời và diễn tập theo chặng.",
    color: "magenta",
  },
];
