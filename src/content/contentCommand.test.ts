...
const createAudioCommandFixture = () => {
  ...
  registry.packages = registry.packages.filter(
    ({ contentVersion }) => ![
      ...
      "foundation-2026.08.5",
      "foundation-2026.08.6",
      "foundation-2026.08.7",
...
describe("content validation command", () => {
  it("validates every registered package when no version is supplied", async () => {
    ...
    expect(report.packages).toEqual([
      ...
      { contentVersion: "foundation-2026.08.3", valid: true, errors: [], warnings: [] },
      { contentVersion: "foundation-2026.08.4", valid: true, errors: [], warnings: [] },
      { contentVersion: "foundation-2026.08.5", valid: true, errors: [], warnings: [] },
      { contentVersion: "foundation-2026.08.6", valid: true, errors: [], warnings: [] },
      { contentVersion: "foundation-2026.08.7", valid: true, errors: [], warnings: [] },
    ]);
  });
