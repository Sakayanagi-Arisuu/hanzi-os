...
describe("pinned official HSK1-4 syllabus inventory", () => {
  ...
  it("reports current coverage without making an HSK completion claim", () => {
    ...
    expect(
      ...
      completedDomains: 3,
      lessons: 15,
      vocabularyDrafts: 307,
      authoredTexts: 30,
      authoredTextLines: 240,
      vocabularyPracticeItems: 921,
      comprehensionItems: 150,
      noteGridItems: 30,
      guidedSummaryItems: 30,
      authoredPracticeItems: 1131,
      audioDependentItems: 412,
      reviewBatches: 15,
      reviewedAudioItems: 0,
      measurementEligibleItems: 0,
      reviewed: false,
