...
describe("pinned official HSK1-4 syllabus inventory", () => {
  ...
  it("reports current coverage without making an HSK completion claim", () => {
    ...
    expect(
      ...
      completedDomains: 2,
      lessons: 10,
      vocabularyDrafts: 207,
      authoredTexts: 20,
      authoredTextLines: 160,
      vocabularyPracticeItems: 621,
      comprehensionItems: 100,
      noteGridItems: 20,
      guidedSummaryItems: 20,
      authoredPracticeItems: 761,
      audioDependentItems: 277,
      reviewBatches: 10,
      reviewedAudioItems: 0,
      measurementEligibleItems: 0,
      reviewed: false,
